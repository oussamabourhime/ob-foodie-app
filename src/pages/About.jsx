    ...
    <div className="w-full overflow-hidden">
      ...
      >
       ...
       <div className="absolute inset-0 bg-black bg-opacity-50 flex flex-col items-center justify-center text-center text-white z-10 px-4 md:pt-10">
          <h2 className="mini-title text-amber-400 text-xl md:text-3xl font-bold mb-4">Welcome to OB Restaurant!</h2>
          <p className="font-bold text-lg md:text-2xl max-w-4xl " style={{ textShadow: "0 0 5px orange" }}>
            Experience fine dining with a blend of tradition and modern culinary art.
          </p>
        </div>
      </section>
      ...
      <section id="about-section" className=" text-white px-6 md:px-16 py-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          <div className="about-text space-y-6 text-lg leading-relaxed ">
            ...
            t OB Foodie Restaurant, we take you on a culinary journey around the world — all in one place.
             Our menu celebrates the rich flavors and traditions of international cuisines,
              from sizzling Asian stir-fries to hearty Mediterranean dishes and vibrant Latin creations.
               Every plate is crafted with passion, using fresh ingredients and authentic recipes,
                so you can taste the world without leaving your seat. Whether you’re here for a casual meal, 
                a romantic dinner, or a festive gathering, we promise a warm atmosphere, exceptional service,
                 and flavors that make every visit unforgettable. At OB’s, it’s not just dining — it’s global flavor,
                  shared.</p>
            
            <p className="text-amber-400 font-bold pt-10">
              <span className="text-white font-bold text-2xl">W</span>e make the best food
              with the fine spices and we have the best chefs.
            </p>
            <p className="text-amber-400 font-bold">
              <span className="text-white font-bold text-2xl">O</span>ur restaurant is the
              best place to enjoy your meal with your family and friends.
            </p>
            <p className="text-amber-400 font-bold">
              <span className="text-white font-bold text-2xl">O</span>ur dishes are made with love and the finest ingredients
               from around the world.
            </p>
            <p className="text-amber-400 font-bold">
              <span className="text-white font-bold text-2xl">W</span>e are open all the
              time for your happy and the best enjoy with us.
            </p>
          </div>
