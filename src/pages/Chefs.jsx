    ...
    <div className="w-full overflow-hidden">
      ...
      >
       ...
       <div className="absolute inset-0 bg-black bg-opacity-50 flex flex-col items-center justify-center text-center text-white z-10 px-4 md:pt-10">
          <h2 className="mini-title text-amber-400 text-xl md:text-3xl font-bold mb-4">Our Chefs!</h2>
      ...
      <section id="chefs-section" className=" text-white px-6 md:px-16 py-20">
       ...
       <div className="grid gap-10 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 items-center">
                <div className="chef-card">
                  ...
                  <p className="font-bold text-amber-500"> <span className="text-white">Specialty :</span> Moroccan Cuisine</p>
                ...
                <div className="chef-card">
                  ...
                  <p className="font-bold text-amber-500"> <span className="text-white">Specialty :</span> Japanese Cuisine</p>
                 <ul className="flex justify-center space-x-4 py-3">
                    <li>
                        <a
                       href="https://facebook.com/"
                ...
                <div className="chef-card">
                  ...
                  <p className="font-bold text-amber-500"> <span className="text-white">Specialty :</span> Spanish Cuisine</p>
                 <ul className="flex justify-center space-x-4 py-3">
                    <li>
                        <a
                        href="https://facebook.com/"
                ...
                <div className="chef-card">
                  ...
                  <p className="font-bold text-amber-500"> <span className="text-white">Specialty :</span> Italian Cuisine</p>
                 <ul className="flex justify-center space-x-4 py-3">
                    <li>
                        <a
                        href="https://facebook.com/"
                ...
                <div className="chef-card">
                  ...
                  <p className="font-bold text-amber-500"> <span className="text-white">Specialty :</span> Turkish Cuisine</p>
                 <ul className="flex justify-center space-x-4 py-3">
                    <li>
                        <a
                        href="https://facebook.com/"
                ...
                <div className="chef-card">
                  ...
                  <p className="font-bold text-amber-500"> <span className="text-white">Specialty :</span> French Cuisine</p>
                 <ul className="flex justify-center space-x-4 py-3">
                    <li>
                        <a
                        href="https://facebook.com/"
                ...
                <div className="chef-card">
                  ...
                  <p className="font-bold text-amber-500"> <span className="text-white">Specialty :</span> Indian Cuisine</p>
                 <ul className="flex justify-center space-x-4 py-3">
                    <li>
                        <a
                        href="https://facebook.com/"
