          ...
          >
            ...
            <div className="w-full h-full flex items-center justify-center bg-black bg-opacity-50 pt-40 md:pt-16">
              <div className="text-center text-white px-4 md:px-6 max-w-xl">
                ...
                <button
                  onClick={() => {
                    window.location.href = "/menu#menu-section";
                  }}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          <div className="about-text space-y-6 text-lg leading-relaxed ">
            <p className="text-amber-400 font-bold pt-10">
              <span className="text-white font-bold text-2xl">W</span>e craft
              every dish with premium spices and flavors, prepared by our
              world-class chefs.
            </p>
            <p className="text-amber-400 font-bold">
              <span className="text-white font-bold text-2xl">O</span>ur
              restaurant is the perfect spot to share unforgettable meals with
              family and friends.
            </p>
            <p className="text-amber-400 font-bold">
              <span className="text-white font-bold text-2xl">E</span>ach dish
              is made with care, using the freshest and finest ingredients
              sourced globally. from around the world.
            </p>
            <p className="text-amber-400 font-bold">
              <span className="text-white font-bold text-2xl">W</span> e’re
              always here to welcome you, ensuring every visit is filled with
              joy and great taste.
            </p>
          </div>
      ...
      <section id="flags-section" className="w-full  py-16 px-4">
        <div className="max-w-6xl mx-auto text-center mb-6">
          <h2 className=" mini-title text-3xl md:text-4xl font-bold text-amber-400 mb-6 flex items-center gap-1 pb-10">
            <span className="border-t-2 border-amber-400 w-8"></span> Our
