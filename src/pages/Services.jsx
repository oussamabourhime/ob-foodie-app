...
import { FaUserTie, FaUtensils,  FaCartPlus, FaHeadset,FaTv , FaTruck, FaBirthdayCake, FaClock, FaGift, FaLeaf} from "react-icons/fa";
import "./Services.css";
    ...
    <div className="w-full overflow-hidden">
      ...
      >
       ...
       <div className="absolute inset-0 bg-black bg-opacity-50 flex flex-col items-center justify-center text-center text-white z-10 px-4 md:pt-10">
          <h2 className="mini-title text-amber-400 text-xl md:text-3xl font-bold mb-4">Our Services!</h2>
      ...
      <section id="service-section" className=" text-white px-6 md:px-16 py-20">
       ...
       <div className="grid gap-10 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 items-center">
                ...
                <div className="card">
                  <FaTv size={60} />
                  <h3>Big TV</h3>
                  <p  className="font-bold text-amber-500">Experience Our Services on the Big Screen of Flavor!.</p>
                </div>
                <div className="card">
                  <FaTruck size={60} />
                  <h3>Home Delivery</h3>
                  <p  className="font-bold text-amber-500"> Enjoy our delicious meals from the comfort of your home with our
              fast and reliable home delivery service!</p>
                </div>
                <div className="card">
                <FaBirthdayCake size={60} />
                <h3>Birthday place</h3>
                <p  className="font-bold text-amber-500">Celebrate Your Special Day with Us The Perfect Place for
              Unforgettable Birthday Memories!</p>
                </div>
                 <div className="card">
                    <FaMusic size={60} />
                      <h3>Calm music</h3>
                    <p  className="font-bold text-amber-500">  We have a calm music and a place without music if you don't like
              it .</p>
                </div>
                <div className="card">
                    <FaSun size={60} />
                      <h3>Outdoor Seating</h3>
                    <p  className="font-bold text-amber-500">   Enjoy your meal in the fresh air with our cozy outdoor seating,
              perfect for a relaxing dining experience!
                 ...
                 <div className="card">
                    <FaClock size={60} />
                      <h3>Fast Making</h3>
                    <p  className="font-bold text-amber-500">Enjoy fast, flawless service and perfectly crafted dishes made to satisfy your cravings!
              </p>
                </div>
                <div className="card">
                    <FaGift size={60} />
                    <h3>Special Offers</h3>
                    <p  className="font-bold text-amber-500">Enjoy special offers and discounts for an unforgettable dining experience!
              </p>
                </div>
                <div className="card">
                    <FaLeaf size={60} />
                    <h3>Vegan Options</h3>
                    <p  className="font-bold text-amber-500"> We offer a variety of delicious vegan dishes that are as flavorful
